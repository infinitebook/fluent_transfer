...
class Ui_FocusInterface(object):
    def setupUi(self, FocusInterface):
        ...
        icon = QIcon()
        icon.addFile(u":/images/todo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.taskCardIcon.setIcon(icon)
        ...
        sizePolicy.setHeightForWidth(self.taskIcon4.sizePolicy().hasHeightForWidth())
        self.taskIcon4.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.taskCard, 2, 0, 1, 2)
        ...
        sizePolicy1.setHeightForWidth(self.progressCard.sizePolicy().hasHeightForWidth())
        self.progressCard.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_5.addWidget(self.ToolButton_4, 3, 3, 1, 1)

        self.horizontalSpacer_17 = QSpacerItem(30, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_5.addItem(self.horizontalSpacer_17, 3, 4, 1, 1)
        ...
        self.gridLayout_5.addItem(self.horizontalSpacer_18, 3, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.ToolButton1, 2, 1, 1, 1)

        self.horizontalSpacer_16 = QSpacerItem(30, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_5.addItem(self.horizontalSpacer_16, 2, 0, 1, 1)
        ...
        self.gridLayout_5.addItem(self.horizontalSpacer_15, 2, 4, 1, 1)
        ...
        self.gridLayout_5.addLayout(self.horizontalLayout_4, 0, 0, 1, 5)

        self.ToolButton_2 = ToolButton(self.progressCard)
        self.ToolButton_2.setObjectName(u"ToolButton_2")
        self.ToolButton_2.setMinimumSize(QSize(131, 141))

        self.gridLayout_5.addWidget(self.ToolButton_2, 2, 3, 1, 1)

        self.verticalSpacer_9 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_5.addItem(self.verticalSpacer_9, 4, 3, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.focusCard.sizePolicy().hasHeightForWidth())
        self.focusCard.setSizePolicy(sizePolicy1)
        ...
        self.IndeterminateProgressBar = IndeterminateProgressBar(self.focusCard)
        self.IndeterminateProgressBar.setObjectName(u"IndeterminateProgressBar")

        self.gridLayout_4.addWidget(self.IndeterminateProgressBar, 0, 0, 1, 3)
        ...
        self.gridLayout_4.addLayout(self.horizontalLayout_16, 5, 0, 1, 3)

        self.verticalSpacer_3 = QSpacerItem(20, 13, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_4.addItem(self.verticalSpacer_3, 6, 1, 1, 1)
        ...
        self.horizontalLayout_17.addWidget(self.BodyLabel)
        ...
        self.horizontalLayout_17.addWidget(self.translate_SwitchButton)
        ...
        self.horizontalLayout_18.addWidget(self.country_selector)

        self.horizontalSpacer_23 = QSpacerItem(15, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_18.addItem(self.horizontalSpacer_23)


        self.gridLayout_4.addLayout(self.horizontalLayout_18, 7, 0, 1, 3)

        self.verticalSpacer_4 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Fixed)

        self.gridLayout_4.addItem(self.verticalSpacer_4, 8, 1, 1, 1)

        self.horizontalSpacer_12 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_4.addItem(self.horizontalSpacer_12, 9, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.startFocusButton, 9, 1, 1, 1)

        self.horizontalSpacer_11 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_4.addItem(self.horizontalSpacer_11, 9, 2, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.gridLayout_4.addItem(self.verticalSpacer, 10, 1, 1, 1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/alarms.png", QSize(), QIcon.Normal, QIcon.Off)
        self.focusCardIcon.setIcon(icon2)
    ...
    def retranslateUi(self, FocusInterface):
        ...
        self.file_LineEdit.setText(QCoreApplication.translate("FocusInterface", u"\u6587\u4ef6\u76ee\u5f55", None))
        ...
        self.country_selector.setText(QCoreApplication.translate("FocusInterface", u"\u56fd\u5bb6", None))
